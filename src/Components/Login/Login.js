    ...
    return (
        <div className="login">
            ...
            <form action="">
                ...
                {isNew ? 
                    <div style={{color: 'red'}}>
                        {!isPasswordValid.isUpper && <li>one uppercase character</li>}
                        {!isPasswordValid.isLower && <li>one lowercase character</li>}
                        {!isPasswordValid.isNumber && <li>one number</li>}
                        {!isPasswordValid.isLength && <li>minimum 6 character</li>}<br/>
            ...
            <button className="google-fb" onClick={handleFbSignIn}>Login with Facebook</button><br/>
            <button className="google-fb" onClick={handleGoogleSignIn}>Login with Google</button>
        </div>
    );
};
